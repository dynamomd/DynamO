...
** Version Milestones
*** DynamO 1.3
**** DONE Up to 50% faster in polydisperse systems thanks to a new cache friendly nblist implementation.
...
**** TODO Remove the repeated code in the neighbourlist callbacks.
**** TODO Move to the complex scheduler.
...
**** TODO Move to deferred lighting (Use the depth buffer from the render pass).
...
**** TODO Expose the get neighborhood functions in the scheduler for patrics work.
...
**** TODO Remove the Dynamics tags in the config and rename the Liouvillean to Dynamics.
