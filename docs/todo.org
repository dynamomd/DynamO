...
*** Dynamo 1.2
**** DONE *Improvement* XML errors are now much more verbose and tell you exactly what went wrong.
**** DONE *Improvement* The DynamO-Coil integration can be forcibly enabled or disabled at build time.
...
**** TODO Change the build configuration steps to setting features.
**** TODO Multicanonical simulations.
