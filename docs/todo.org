...
**** DONE Coil: Now requires and successfully supports the OpenGL 3.3 Core profile.
...
**** TODO Magnet: Move all shaders to GLSL 330.
...
**** TODO Coil: Sort out the console output in coil, do we need it? it's a mess in clWindow.cpp
