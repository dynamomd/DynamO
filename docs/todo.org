...
**** DONE *MAJOR* New dynamod mode (-m 26) - Example Polydisperse Hard Spheres Configuration!
...
**** TODO *BUG* All Stepped potential will not work for static & dynamic particle collisions, if an inner collision occurs an escape may occur earlier
**** TODO Fix the segfault when a simulation closes coil through a shutdown.
