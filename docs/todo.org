...
**** DONE Coil: Added gamma correction to Coil.
...
**** TODO DynamO: Check that the PBC sentinel is correctly working for 2 particles, it seems something else is doing the updates.
