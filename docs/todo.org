...
** Version Milestones
*** DynamO 1.3
**** Optimized triangle meshes by inserting them into the neighbor lists.
*** DynamO 1.2
...
**** DONE Multicanonical and replica-exchange simulations.
...
**** DONE Removed the 3d output for the tinkerXYZ plugin.
