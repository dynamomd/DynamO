...
**** TODO *BUG* Fixed rendering on low end GPU's, the render target was not getting resized.
...
**** TODO *BUG* Fixed compression of shearing systems failing due to an incorrect rescaling of the box shift in the BC's.
