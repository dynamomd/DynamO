...
**** TODO Coil: Add a "line" primitive to Coil, for bonds.
...
**** TODO DynamO: Rename gcellsmorton.hpp/cpp.
...
**** TODO DynamO: Check the neighbourlist size on initialisation to make sure its valid.
*** DynamO 1.2							    :ARCHIVE:
