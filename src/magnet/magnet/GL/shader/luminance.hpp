...
public:
  virtual std::string initFragmentShaderSource() {
    return STRINGIFY(
        ...
        smooth in vec2 screenCoord; layout(location = 0) out vec4 L_out;
        ...
        void main() {
          ...
          // Prevent logarithms of zero, store the log(L), max L, min L,
          // weight/alpha
          ...
          // 16-bit floating point value. The smallest floating point value is
          // 2^{-14}
        });
  }
};
