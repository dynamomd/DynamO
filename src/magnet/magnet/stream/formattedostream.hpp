...
class FormattedOStream : public std::ostream {
  ...
  public:
    FormatingStreamBuf(const std::string &prefix, std::ostream &ostream,
                       const size_t linelength)
        : _output(ostream), _linelength(linelength), _prefix(prefix) {}

    /*! \brief Copy constructor. */
    FormatingStreamBuf(const FormatingStreamBuf &os)
        : _output(os._output), _linelength(os._linelength),
          _prefix(os._prefix) {}
    ...
    virtual int sync() {
      ...
      std::string ostring =
          string::linewrap<true>(_prefix + str(), _linelength);
...
public:
  /*! \brief Constructor.
    ...
    \param ostream The underlying output stream or final destination of the
    formatted output.
  ...
  inline FormattedOStream(std::ostream &ostream = std::cout,
      ...
      : std::ostream(&_buffer), _buffer(prefix, ostream, linelength) {}
  ...
  FormattedOStream(const FormattedOStream &os)
      : std::ostream(&_buffer), _buffer(os._buffer) {}
