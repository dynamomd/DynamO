...
namespace magnet {
namespace math {
inline size_t ferrariQuarticSolve(const double &a, const double &b,
  ...
  double d4;
  double yinv2;
  double v1[4] = {0, 0, 0, 0}, v2[4] = {0, 0, 0, 0}, v3[4] = {0, 0, 0, 0};
  double p, q, r;
  double y;
  ...
  for (size_t j3 = 0; j3 < n3; ++j3) {
    ...
    if ((esq < 0.0) && (fsq < 0.0))
      ...
      if (((b > 0.0) && (y > 0.0)) || ((b < 0.0) && (y < 0.0))) {
        if (((a > 0.0) && (e > 0.0)) || ((a < 0.0) && (e < 0.0)))
          g = (b + y) / gg;
        else if (((a > 0.0) && (e < 0.0)) || ((a < 0.0) && (e > 0.0)))
          gg = (b + y) / g;
      }
      hh = -yinv2 + f;
      h = -yinv2 - f;
      if (((f > 0.0) && (y < 0.0)) || ((f < 0.0) && (y > 0.0)))
        h = d / hh;
