...
template <size_t val, size_t base> struct ctime_floor_log_worker {
  static const size_t result =
      ctime_floor_log_worker<val / base, base>::result + 1;
};

template <size_t base> struct ctime_floor_log_worker<0, base> {
...
template <size_t base> struct ctime_ceil_log_tester<1, base, 0> {
  static const size_t result = 0;
};

template <size_t base> struct ctime_ceil_log_tester<0, base, 0> {
  static const size_t result = 0;
};

template <size_t val, size_t base> struct ctime_ceil_log_tester<val, base, 0> {
  static const size_t result =
      ctime_ceil_log_tester<val / base, base, val % base>::result;
};
#endif
} // namespace detail
 ...
 */
template <size_t val, size_t base> struct ctime_floor_log {
  static const size_t result =
      detail::ctime_floor_log_worker<val / base, base>::result;
};
 ...
 */
template <size_t val, size_t base> struct ctime_ceil_log {
  static const size_t result =
      ctime_floor_log<val, base>::result +
      detail::ctime_ceil_log_tester<val / base, base, val % base>::result;
};

#ifndef DOXYGEN_SHOULD_IGNORE_THIS
template <size_t base> struct ctime_ceil_log<1, base> {
  static const size_t result = 0;
};
