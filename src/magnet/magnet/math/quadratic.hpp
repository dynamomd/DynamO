...
namespace magnet {
  namespace math {
    ...
    */
    ...
    inline size_t
    quadSolve(const double f0, const double f1, const double f2, double& root1, double& root2)
    {
    ...
    inline bool 
    quadraticSolve(const double& C, const double& B, const double& A, double& root1, double& root2)
    {
      try {
