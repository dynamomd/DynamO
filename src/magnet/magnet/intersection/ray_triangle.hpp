...
inline double ray_triangle(const math::Vector &T, const math::Vector &D,
                           const math::Vector &E1, const math::Vector &E2) {
  math::Vector P = D ^ E2;
  double det = E1 | P;
