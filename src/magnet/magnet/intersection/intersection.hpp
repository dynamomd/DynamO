...
template <class TA, class TB> class IntersectionOverlapFunction {
public:
  IntersectionOverlapFunction(const TA &fA, const TB &fB) : _fA(fA), _fB(fB) {}
...
IntersectionOverlapFunction<TA, TB> make_intersection(const TA &fA,
                                                      const TB &fB) {
