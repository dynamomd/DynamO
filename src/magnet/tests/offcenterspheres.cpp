...
BOOST_AUTO_TEST_CASE( OffCentreSphereGrowing_Test )
{
  ...
  magnet::intersection::detail::OffcentreSpheresOverlapFunction f1(r1 - r2, v1 - v2, angv1, angv2, relativepos1, relativepos2, diam1, diam2, (r1-r2).nrm() + 1.0, 0, invgamma, 0, 0.363046);
  auto result1 = f1.nextEvent();
