...
#ifndef BOOST_RANDOM_NORMAL_DISTRIBUTION_01_HPP
#define BOOST_RANDOM_NORMAL_DISTRIBUTION_01_HPP
...
public:
  ...
  explicit normal_distribution_01()
    : _valid(false)
  {  }

  // compiler-generated copy constructor is NOT fine, need to purge cache
  normal_distribution_01(const normal_distribution_01&)
    : _valid(false)
  {}
  ...
  result_type operator()(Engine& eng)
  {
    ...
    return _valid ? _r1 : _r2;
  }

#if !defined(BOOST_NO_OPERATORS_IN_NAMESPACE) && !defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
  template<class CharT, class Traits>
  friend std::basic_ostream<CharT,Traits>&
  operator<<(std::basic_ostream<CharT,Traits>& os, const normal_distribution_01& nd)
  {
  ...
  operator>>(std::basic_istream<CharT,Traits>& is, normal_distribution_01& nd)
  {
...
#endif // BOOST_RANDOM_NORMAL_DISTRIBUTION_01_HPP
