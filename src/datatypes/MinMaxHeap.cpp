...
const Comparable & MinMaxHeap<Comparable,Size>::top() const
{
#ifdef DYNAMO_DEBUG
  if (empty())
...
template <class Comparable, size_t Size>
const Comparable & MinMaxHeap<Comparable,Size>::bottom() const
{
#ifdef DYNAMO_DEBUG
  if ( empty() )
...
template <class Comparable, size_t Size>
Comparable & MinMaxHeap<Comparable,Size>::unsafe_bottom()
{
#ifdef DYNAMO_DEBUG
  if ( empty() )
    M_throw() << "*** FindMax failed: Heap is empty ***";
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::insert( const Comparable & x )
{
#ifdef DYNAMO_DEBUG
  if( full() )
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateUp( size_t hole )
{
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateUpMin( size_t hole )
{
...
// Parameter hole: index in array of item to be percolated
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateUpMax( size_t hole )
{
  size_t grandparent = hole / 4;
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::deleteMin( Comparable & minItem )
{
#ifdef DYNAMO_DEBUG
  if( empty() )
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::pop()
{
#ifdef DYNAMO_DEBUG
  if( empty() )
    M_throw() << "*** DeleteMin failed: Heap is empty ***";
...
// Side Effects: throws Underflow if heap is empty
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::deleteMax( Comparable & maxItem )
{
  size_t maxIndex;
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::replaceMax(const Comparable & newMaxItem)
{
  size_t maxIndex;
...
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateDown( size_t hole )
{
  size_t level = 0;
...
// Parameter hole: index in array of item to be percolated
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateDownMin(size_t hole)
{
...
// Parameter hole: index in array of item to be percolated
template <class Comparable, size_t Size>
void MinMaxHeap<Comparable,Size>::percolateDownMax( size_t hole )
{
  size_t maxIndex;
...
template <class Comparable, size_t Size>
size_t MinMaxHeap<Comparable,Size>::findMinDescendent( size_t child, size_t grandchild )
{
  size_t minIndex = 0;
...
// Parameter grandchild: array index of first grandchild
template <class Comparable, size_t Size>
size_t MinMaxHeap<Comparable,Size>::findMaxDescendent( size_t child, size_t grandchild )
{
  size_t maxIndex = 0;
