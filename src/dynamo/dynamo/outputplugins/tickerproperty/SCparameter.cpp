...
void OPSCParameter::output(magnet::xml::XmlStream &XML) {
  XML << magnet::xml::tag("SCParameter") << magnet::xml::attr("SCWaveNumber")
...
void OPSCParameter::operator<<(const magnet::xml::Node &XML) {}
} // namespace dynamo
