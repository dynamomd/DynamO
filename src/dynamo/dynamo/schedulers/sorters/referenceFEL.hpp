...
namespace dynamo {
  ...
  public:
    ...
    virtual void invalidate(const size_t id) {
      auto test = [=](const Event& e){ return (e._particle1ID == id) || ((e._source == INTERACTION) && (e._particle2ID == id));};
      
      _store.erase(std::remove_if(_store.begin(), _store.end(), test), _store.end());
    }
