...
public:
  ...
  LCylinder(dynamo::Simulation *nSim, T1 e, T2 d, Vector naxis, Vector norigin,
            double cyl_radius, std::string nname, IDRange *nRange)
      : Local(nRange, nSim, "LocalCylinderWall"), vAxis(naxis),
        vPosition(norigin),
