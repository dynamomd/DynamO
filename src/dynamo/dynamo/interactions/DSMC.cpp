...
namespace dynamo {
  ...
  void 
  IDSMC::outputXML(magnet::xml::XmlStream& XML) const
  {
    XML << magnet::xml::attr("Type") << "DSMC"
  ...
  size_t
  IDSMC::captureTest(const Particle& p1, const Particle& p2) const
  {
  ...
  bool
  IDSMC::validateState(const Particle& p1, const Particle& p2, bool textoutput) const
  {
    const double l = _length->getProperty(p1, p2);
