...
{  
  try {
    ...
    //size_t N = 2 * 1024;
    //sphereDetailLevels.push_back(RTSpheres::SphereDetails(Sphere::icosahedron, 2, 256));
    //sphereDetailLevels.push_back(RTSpheres::SphereDetails(Sphere::icosahedron, 1, 256));
    //sphereDetailLevels.push_back(RTSpheres::SphereDetails(Sphere::icosahedron, 0, 256));
    //sphereDetailLevels.push_back(RTSpheres::SphereDetails(Sphere::octahedron, 0, 256));
    //sphereDetailLevels.push_back(RTSpheres::SphereDetails(Sphere::tetrahedron, 0, 1024));
